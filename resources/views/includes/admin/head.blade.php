    ...
    <title>{{ $title }} | Blog writer - Admin</title>

    <!-- Bootstrap Core CSS -->
    <link href="{{ URL::asset('back/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="{{ URL::asset('back/css/metisMenu.min.css') }}" rel="stylesheet">
    ...
    <!-- Custom Fonts -->
    <link href="{{ URL::asset('back/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
